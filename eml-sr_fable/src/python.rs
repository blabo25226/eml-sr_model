...
create_exception!(eml_sr_fable, EmlDimensionError, PyException);
create_exception!(eml_sr_fable, EmlComplexityError, PyException);
create_exception!(eml_sr_fable, EmlRuntimeError, PyException);
...
impl PySearcher {
    ...
    fn new(
        ...
        config.refinement_top_k = refinement_top_k;
...
#[pymodule(name = "eml_sr_fable")]
fn eml_sr_fable(py: Python, m: &Bound<'_, PyModule>) -> PyResult<()> {
