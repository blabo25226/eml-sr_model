...
**結果: 完全回収 19/20、部分 0、失敗 1、総時間 0.5 分**
...
| 3 | `nguyen5` | trig-comp | ✅ ok | 3.846e-17 | 8 | `Plus(Times(Cos(v_{0}), Sin(Square(v_{0}))), -1)` | 3.7 |
| 4 | `nguyen6` | trig-comp | ❌ failed | 2.606e-02 | 39 | `Plus(Plus(Plus(Plus(Plus(Plus(Plus(-21.57154028...` | 5.1 |
...
| 8 | `rational3` | rational | ✅ ok | 2.041e-15 | 8 | `Inv(Plus(Inv(v_{0}), Times(0.9999999999999962, ...` | 0.4 |
...
| 13 | `saturation` | exp | ✅ ok | 3.714e-08 | 37 | `Divide(Plus(Plus(Plus(0.8061003727739423, Times...` | 10.5 |
| 14 | `exp_decay` | exp | ✅ ok | 1.469e-14 | 7 | `Exp(Plus(Times(-0.4999999999999974, Square(v_{0...` | 0.0 |
| 15 | `mixed_prod` | mixed | ✅ ok | 8.568e-17 | 5 | `Divide(v_{0}, Exp(Square(v_{1})))` | 1.3 |
| 16 | `sine_amp` | mixed | ✅ ok | 0.000e+00 | 4 | `Times(v_{0}, Sin(v_{1}))` | 0.3 |
| 17 | `gauss2d` | exp | ✅ ok | 4.129e-16 | 10 | `Exp(Plus(Times(-0.500000000000001, Square(v_{1}...` | 0.1 |
