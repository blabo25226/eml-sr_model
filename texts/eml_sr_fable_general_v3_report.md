...
**結果: 完全回収 19/20、部分 0、失敗 1、総時間 0.6 分**
...
| 3 | `nguyen5` | trig-comp | ✅ ok | 3.846e-17 | 8 | `Plus(Times(Cos(v_{0}), Sin(Square(v_{0}))), -1)` | 3.8 |
| 4 | `nguyen6` | trig-comp | ❌ failed | 9.686e-02 | 28 | `Divide(Plus(Plus(Plus(-2.2961510312647047, Time...` | 5.1 |
| 5 | `nguyen7` | log | ✅ ok | 7.273e-06 | 36 | `Divide(Plus(Plus(Plus(6.91208985959771, Times(-...` | 10.1 |
...
| 8 | `rational3` | rational | ✅ ok | 2.041e-15 | 8 | `Inv(Plus(Inv(v_{0}), Times(0.9999999999999962, ...` | 0.5 |
| 9 | `shifted_inv` | rational | ✅ ok | 1.362e-14 | 6 | `Inv(Plus(0.8333333333333319, Times(0.3333333333...` | 0.1 |
